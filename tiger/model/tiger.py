...
class TIGE(nn.Module):
    def __init__(self, *, raw_feat_getter: FeatureGetter, graph: Graph,
                 ...
                 hit_type: str='none', importance_dim: int = 100, shift_max: float = 0.,
                 threshold:float = 0., adl_control:float = 1.0):
        """
        ...
        self.temporal_embedding_fn = GraphAttnEmbedding(
            ...
            dropout=dropout, importance_dim=importance_dim,
            shift_max=shift_max
        )
...
class TIGER(TIGE):
    ...
    def __init__(self, *, raw_feat_getter: FeatureGetter, graph: Graph, restarter: Restarter,
                 ...
                 msg_tsfm_type: str='id', mem_update_type: str='gru',
                 tgn_mode: bool=True, msg_last_only: bool=True,
                 hit_type: str='vec', importance_dim: int = 100, shift_max: float = 0.0,
                 threshold:float = 1.0, adl_control:float = 0.0):
        """
        ...
        super().__init__(
            ...
            hit_type=hit_type, importance_dim=importance_dim, shift_max=shift_max,
    ...
    def contrast_and_mutual_learning(
        ...
        """
        contrast_loss, *_, h_prev_left, h_prev_right, attentions = self.contrast_learning(
